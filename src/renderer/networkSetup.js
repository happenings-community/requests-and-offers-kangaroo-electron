...
window.showJoinSection = showJoinSection;
  ...
  try {
    ...
    setTimeout(() => {
      document.getElementById('statusMessage').innerHTML =
        'Network created! <button onclick="launchApp()">Launch App</button>';
    }, 2000);
  } catch (error) {
...
async function joinNetwork() {
  ...
  try {
    ...
    setTimeout(() => {
      document.getElementById('statusMessage').innerHTML =
        'Network joined! <button onclick="launchApp()">Launch App</button>';
    }, 2000);
  } catch (error) {
...
async function launchApp() {
  try {
    ...
    document.getElementById('statusMessage').innerHTML =
      'Error launching. Please close and restart manually.';
  }
}
